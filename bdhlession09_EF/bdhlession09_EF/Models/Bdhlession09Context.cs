...
public partial class Bdhlession09Context : DbContext
{
    public Bdhlession09Context()
    {
    }

    public Bdhlession09Context(DbContextOptions<Bdhlession09Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-7UOTRM2\\SQLEXPRESS;Database=bdhlession09;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A69538F2A9");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2079FC0DA93");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B80F3369B");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFB605A212");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C0485B928");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB4BC1B080");
